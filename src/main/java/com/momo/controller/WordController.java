...
public class WordController {
    ...
    private Word parseSingleWordBlock(String block) {
        ...
        while (i < len) {
            ...
            switch (key) {
                case "id": w.setId(val); break;
                case "word": w.setWord(val); break;
                case "phonetic": w.setPhonetic(val); break;
                case "definition": w.setDefinition(val); break;
                case "example": w.setExample(val); break;
                case "category": w.setCategory(val); break;
            }
